import 'package:fellow4u/pages/inexplore/chooseAGuides/choose/chooseTuan.dart';
import 'package:flutter/material.dart';
import 'package:page_transition/page_transition.dart';
import '../SeeMore/seeMoreTravelNew.dart';

class GuideTuan extends StatefulWidget {
  const GuideTuan({super.key});

  @override
  State<GuideTuan> createState() => _GuideTuanState();
}

class _GuideTuanState extends State<GuideTuan> {
                ...
                child: Container(
                  ...
                  decoration: const BoxDecoration(
                    ...
                    image: DecorationImage(
                      image: AssetImage('lib/image/headerTuan.png'),
                      fit: BoxFit.cover,
                    ),
                  ),
                  child: Column(
                ...
                child: Padding(
                  ...
                  child: Container(
                    ...
                    child: const CircleAvatar(
                      backgroundImage: AssetImage('lib/image/Tuan.png'),
                    ),
                  ),
                ),
              ),
              ...
              Row(
                ...
                children: [
                  ...
                  InkWell(
                    ...
                    onTap: (){
                      Navigator.push(context, PageTransition(child: ChooseTuan(), type: PageTransitionType.bottomToTop));
                    },
                  ),
                ],
              ),
